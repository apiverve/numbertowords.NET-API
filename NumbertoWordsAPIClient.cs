...
namespace APIVerve
{
    public class NumbertoWordsAPIClient
    {
        ...
        public NumbertoWordsAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public NumbertoWordsAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(numbertowordsQueryOptions options)
        {
            try
            {
                if (_isDebug)
